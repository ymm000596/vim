...
""colorsche molokai " 着色模式
set guifont=Monaco           " 字体 && 字号
...
""let Tlist_WinWidth=10 " increase the width of the taglist window
""let Tlist_Auto_Open=0 " automatically open the taglist window 
""let Tlist_Use_SingleClick=1 " open tags with single click
...
" Ctrl + E            一步加载语法模板和作者、时间信息 [非插入模式]
map <c-e> <ESC>:LoadTemplate<CR>
vmap <c-e> <ESC>:LoadTemplate<CR>
